...
<head>
    ...
    <title>Professional Picture Validator - The University of Faisalabad</title>
            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center space-x-6">
                    ...
                    <div class="flex space-x-6 ml-8">
                        ...
                        <a href="picture-validator.php" class="nav-active">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6">
                    ...
                    <div id="uploadSection" class="hidden">
                        <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center mb-6">
                            ...
                            <p class="text-gray-500 mb-4">JPG, PNG, or WebP format (max 5MB)</p>
                    ...
                    <div id="statusContainer" class="mt-6">
                        <div id="statusBox" class="p-4 rounded-lg hidden">
    ...
    <script>
        ...
        async function validateImage(imageData, mode) {
            ...
            try {
                ...
                showStatus('error', 'Connection Error', 'Could not connect to validation service. Make sure Python backend is running on port 5001.');
        ...
        function showStatus(type, title, message) {
            ...
            statusBox.className = `p-4 rounded-lg flex items-center`;
            ...
            switch(type) {
                ...
                case 'error':
                    ...
                    break;
                case 'warning':
                    statusBox.className = 'p-4 rounded-lg flex items-center bg-yellow-100 text-yellow-800';
                    statusIcon.className = 'fas fa-exclamation-triangle text-xl mr-3';
                    break;
                case 'info':
                    statusBox.className = 'p-4 rounded-lg flex items-center bg-blue-100 text-blue-800';
                    statusIcon.className = 'fas fa-info-circle text-xl mr-3';
                    break;
                case 'loading':
                    statusBox.className = 'p-4 rounded-lg flex items-center bg-purple-100 text-purple-800';
